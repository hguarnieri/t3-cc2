...
public interface T3Listener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterTiposite(T3Parser.TipositeContext ctx);
	/**
	 * Exit a parse tree produced by {@link T3Parser#tiposite}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterDescricao(T3Parser.DescricaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link T3Parser#descricao}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterNome(T3Parser.NomeContext ctx);
	/**
	 * Exit a parse tree produced by {@link T3Parser#nome}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterContato(T3Parser.ContatoContext ctx);
	/**
	 * Exit a parse tree produced by {@link T3Parser#contato}.
	 * @param ctx the parse tree
	 */
